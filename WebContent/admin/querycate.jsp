...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>景点区域管理 <span class="c-gray en">&gt;</span> 景点区域查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="3">景点区域查询</th>
				</tr>
				<tr class="text-c">
		...
		<div class="text-c">
			<form action="cate/queryCateByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="catename">按区域名称查询</option>
