...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>游记管理 <span class="c-gray en">&gt;</span> 游记查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="12">游记查询</th>
				</tr>
				<tr class="text-c">
		...
		<div class="text-c">
			<form action="views/queryViewsByCond.action" name="myform" method="post">
