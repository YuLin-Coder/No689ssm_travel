							...
							<form action="index/register.action" method="post" name="myform">
								<table width="60%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input name="sex" type="radio" value="男" id="sex" checked />男
											&nbsp;&nbsp;&nbsp;&nbsp; <input name="sex" type="radio" value="女" id="sex" />女</td>
									</tr>
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input name="birthday" type="text" size="25"
											class="inputBg" id="birthday" readonly="readonly" onclick="WdatePicker()" placeholder="请输入出生日期" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input name="image" type="text" size="25" class="inputBg"
											id="image" readonly="readonly" onclick="selimage();" placeholder="请选择图片" /></td>
									</tr>
									<tr>
